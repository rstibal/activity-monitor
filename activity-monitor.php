...
require_once AM_DIR . 'includes/loggers/class-am-logger-export.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-capabilities.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-super-admin.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-cron.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-auto-updates.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-update-failures.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-post-details.php';
require_once AM_DIR . 'includes/loggers/class-am-logger-privacy.php';
